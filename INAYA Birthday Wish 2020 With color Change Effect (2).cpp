...
int main ()
{
    ...
    if(pass == 14123)
    {
        ...
        if(ans=='y')
        {
            string message11 = "I know you are special. Special to me my friend. I never wanted much.";
            ...
            string message24 = "Do you think that blue portion that I've wrote it?";
        ...
        if(ans3=='y')
        {
            string message30 = "Msg me(Yaarian) with time date dear.";
        ...
        string essage_n2 = "LOVE YOU";
        slow_print(essage_n2,400);
